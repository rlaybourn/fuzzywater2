...
# Account Information
to = 'earlgrey1979@email.com' # Email to send to.
gmail_user = 'earlgrey1979@gmail.com' # Email to send from. (MUST BE GMAIL)
gmail_password = 'banaka44' # Gmail password.
...
msg = MIMEText(ip_lines + "\n")
msg['Subject'] = 'IPs For RaspberryPi on %s' % today.strftime('%b %d %Y')
msg['From'] = email.utils.formataddr(('Recipient','earlgrey1979@gmail.com'))
msg['To'] = email.utils.formataddr(('Author','earlgrey1979@gmail.com'))
# Sends the message
smtpserver.sendmail('earlgrey1979@gmail.com', ['earlgrey1979@gmail.com'], msg.as_string())
